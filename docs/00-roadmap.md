...
| 15  | AI Tutor + gợi ý câu hỏi   | Bốn chế độ trợ giảng cho sinh viên (giải thích, hỏi ngược, phản biện, ra bài luyện tập) — không bao giờ viết slide hay báo cáo thay sinh viên, và không biết gì về điểm; hội thoại là riêng của từng sinh viên. Giảng viên có gợi ý câu hỏi để hỏi nhóm, chỉ hiện trên màn hình chứ không ghi vào tường câu hỏi | ✅         |
